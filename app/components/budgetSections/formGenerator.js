...
//
// var jsonFile = require('./durable.json');
//
...
//           onChange = (e) => {
//             e.preventDefault();
//             props.dispatch(change(jsonFile.name, field.input.name, [...e.target.files]))
//           }
...
//           var triggerText = prop.durable.values && prop.durable.values.goods && prop.durable.values.goods[index] && prop.durable.values.goods[index].name!=undefined ? prop.durable.values.goods[index].name : `${questions.defaultTriggerText} ${index}`
//         return(
...
// })(
// connect(mapStateToProps, mapDispatchToProps)(FormGenerator)
// );
